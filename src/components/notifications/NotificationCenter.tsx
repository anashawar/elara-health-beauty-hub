...
import { Bell, Check, CheckCheck, Package, Tag, ShoppingBag, Sparkles, Gift, ChevronRight, X } from "lucide-react";
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 right-0 rtl:right-auto rtl:left-0 w-full max-w-sm bg-background z-50 flex flex-col shadow-2xl"
            >
              {/* Header */}
