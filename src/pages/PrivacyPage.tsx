...
const content = {
  ...
  ar: {
    ...
    sections: [
      ...
      { title: "5. حقوقك", intro: "عندك سيطرة كاملة على بياناتك. بأي وقت، تگدر:", items: ["تشوف وتعدّل معلوماتك الشخصية من حسابك", "تطلب نسخة من بياناتك", "تطلب حذف حسابك وبياناتك الشخصية (إلا إذا القانون يتطلب الاحتفاظ بيها)"], footer: "للطلبات، راسلنا: info@elarastore.co" },
  ...
  ku: {
    ...
    sections: [
      ...
      { title: "5. مافەکانت", intro: "کۆنترۆڵی تەواوت هەیە لەسەر داتاکانت. لە هەر کاتێکدا، دەتوانیت:", items: ["زانیاری کەسیت لە ئەکاونتەکەتەوە ببینیت و بیگۆڕیت", "داوای کۆپییەک لە داتاکانت بکەیت", "داوا بکەیت ئەکاونت و داتای کەسیت بسڕدرێتەوە (تەنها ئەگەر یاسا داوای نەکات)"], footer: "بۆ داواکارییەکان، ئیمەیڵ بکە بۆ: info@elarastore.co" },
